...
public class PrizeBars implements ItemGroup {
  ...
  public class BronzeBar extends Item {
    ...
    public void initialize() {
      ...
      itemInfo.setDescription(
          "A rare bronze bar which can be redeemed for unique prizes at the server shop.");
  ...
  public class SilverBar extends Item {
    ...
    public void initialize() {
      ...
      itemInfo.setDescription(
          "An esteemed silver bar which can be redeemed for unique prizes at the server shop.");
      itemInfo.setInRecipe(false);
      itemInfo.setShoppable(false);
      itemInfo.setPlacable(false);
      itemInfo.setPhysical(false);
  ...
  public class GoldBar extends Item {
    ...
    public void initialize() {
      ...
      itemInfo.setDescription(
          "An exquisite gold bar which can be redeemed for unique prizes at the server shop.");
      itemInfo.setInRecipe(false);
      itemInfo.setShoppable(false);
      itemInfo.setPlacable(false);
      itemInfo.setPhysical(false);
