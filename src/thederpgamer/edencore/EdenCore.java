        ...
        new Listener<SegmentControllerInstantiateEvent>() {
          ...
          public void onEvent(final SegmentControllerInstantiateEvent event) {
            new StarRunnable() {
              ...
              public void run() {
                try {
                  if (event.getController().getSector(new Vector3i()).x > 100000000
                      || event.getController().getSector(new Vector3i()).y > 100000000
                      || event.getController().getSector(new Vector3i()).z > 100000000) {
