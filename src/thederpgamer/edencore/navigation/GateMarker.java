...
/** STARMADE MOD CREATOR: Max1M DATE: 26.09.2021 TIME: 14:54 */
public class GateMarker extends MapMarker implements LineDrawer {
  ...
  public void drawLines(GameMapDrawer gameMapDrawer) {
    for (Vector3i to : connectionTargetSectors) {
      EdenMapDrawer.instance.drawLinesSector(
          sector, to, new Vector4f(publicFTLColor), new Vector4f(publicFTLColor));
    }
  }
