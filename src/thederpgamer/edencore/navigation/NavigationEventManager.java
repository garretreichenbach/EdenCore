...
/** STARMADE MOD CREATOR: Max1M DATE: 27.09.2021 TIME: 16:51 core of the eventbased update system */
    ...
    StarLoader.registerListener(
        ...
        new Listener<KeyPressEvent>() {
          ...
          public void onEvent(KeyPressEvent keyPressEvent) {
            ...
            if (keyPressEvent.isKeyDown()
                && keyPressEvent.getChar() == 'm'
                && !drawer
                    .isMapActive()) { // TODO this is a very unspecific event and fires way to often
