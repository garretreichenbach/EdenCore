...
/**
 * STARMADE MOD CREATOR: Max1M DATE: 25.09.2021 TIME: 11:31 container class that is basically: name,
 * position and icon to be drawn on map
 */
public class MapMarker implements PositionableSubColorSprite, SelectableSprite, SelectableMapEntry {
  ...
  private transient boolean drawIndication;
