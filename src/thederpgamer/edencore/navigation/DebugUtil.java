...
/** STARMADE MOD CREATOR: Max1M DATE: 26.09.2021 TIME: 15:52 */
public class DebugUtil {
  ...
  public static ArrayList<MapMarker> mockGateNetwork(Vector3i start, int amountGates, long seed) {
    ...
    for (int i = 0; i < amountGates; i++) {
      ...
      sector.set(
          nextIntRange(100, sector.x, rand),
          nextIntRange(100, sector.y, rand),
          nextIntRange(100, sector.z, rand));
