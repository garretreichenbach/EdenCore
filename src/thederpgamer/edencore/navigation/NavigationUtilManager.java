...
/**
 * STARMADE MOD CREATOR: Max1M DATE: 18.09.2021 TIME: 14:57 used to inject saved coords into players
 * "saved coords" list, defined by admin commands, stored persistnetly fully serverside
 */
public class NavigationUtilManager {
  ...
  /**
   * add marker to list. requires synching and saving to have effect
   *
   * @param marker
   */
  ...
  /**
   * adds coord to a list that will be removed upon joining from each players list. requires
   * synching and saving to have effect
   *
   * @param sector
   */
