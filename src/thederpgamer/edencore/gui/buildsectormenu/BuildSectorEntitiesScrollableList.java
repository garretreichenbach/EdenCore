  ...
  private GUIHorizontalButtonTablePane redrawButtonPane(
        ...
        new GUICallback() {
            ...
            if (mouseEvent.pressedLeftMouse()
              ...
              if (sectorData.hasPermission(GameClient.getClientPlayerState().getName(), "EDIT")) {
                GameClient.getClientPlayerState()
                    .getControllerState()
                    .forcePlayerOutOfSegmentControllers();
                  ...
                  if (toEnter != null) {
                    ...
                    GameClient.getClientState()
                        ...
                        .requestControlChange(
                            ...
                            (PlayerControllable) segmentController,
                            new Vector3i(),
          ...
          public boolean isOccluded() {
            return !getState().getController().getPlayerInputs().isEmpty()
                || !sectorData.hasPermission(GameClient.getClientPlayerState().getName(), "EDIT");
          }
        },
    ...
    buttonPane.addButton(
        ...
        new GUICallback() {
          ...
          public boolean isOccluded() {
            return !getState().getController().getPlayerInputs().isEmpty()
                || !sectorData.hasPermission(GameClient.getClientPlayerState().getName(), "DELETE");
          }
        },
        new GUIActivationCallback() {
          @Override
