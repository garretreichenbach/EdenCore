...
public class BuildSectorCatalogScrollableList extends ScrollableTableList<CatalogPermission> {
                      ...
                      public boolean onInput(String s) {
                        ...
                        PacketUtil.sendPacketToServer(
                            new RequestSpawnEntryPacket(
                                s, catalogPermission.getUid(), false, FactionManager.PIRATES_ID));
                        return true;
                      }
                    })
                    .activate();
  ...
  public class BuildSectorCatalogListRow extends ScrollableTableList<CatalogPermission>.Row {
    ...
    @Override
    public boolean isOccluded() {
      return spawnEntityDialog != null
          && spawnEntityDialog.getInputPanel() != null
          && spawnEntityDialog.getInputPanel().isActive();
    }
  }
}
