...
/**
 * STARMADE MOD CREATOR: Max1M DATE: 18.09.2021 TIME: 00:21 used to log transactions persistently.
 * provides static helper methods for banking
 */
public class BankingTransactionLog implements Serializable {
  ...
  public static BankingTransactionLog sendMoney(String from, String to, int credits, String mssg) {
    ...
    if (fromP == null || toP == null || fromP.equals(toP)) return null;

    if (credits <= 0) return null;

    if (!hasMoney(fromP, credits)) return null;
    ...
    // notify receiver
    toP.sendServerMessage(
        Lng.astr("You have received money: \n" + transaction.toStringPretty()),
  ...
  public String toStringPretty() {
    ...
    SimpleDateFormat sdf =
        new SimpleDateFormat("MM/dd/yyyy '-' hh:mm:ss z"); // Chad American format
