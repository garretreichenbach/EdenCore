 ...
 */
public class CaptureTarget extends EventTarget {

  public CaptureTarget(String targetEntityUID) {
    super(targetEntityUID);
  }

  public CaptureTarget(PacketReadBuffer readBuffer) throws IOException {
    super(readBuffer);
  }
  ...
  public int getProgress() {
    ...
    if (entity instanceof Ship) {
      ...
      return (int)
          ((int) ((SpaceStation) entity).getReactorHp()
              / ((SpaceStation) entity).getReactorHpMax());
    } else return 0;
  }
}
