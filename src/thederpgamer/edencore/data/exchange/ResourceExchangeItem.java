...
public class ResourceExchangeItem extends ExchangeItem {
  ...
  public ResourceExchangeItem(
      short barType, int price, String name, String description, short itemId, int itemCount) {
  ...
  public GUIOverlay getIcon() {
    return IconDatabase.getBuildIconsInstance(
        GameClient.getClientState(), ElementKeyMap.getInfo(itemId).getBuildIconNum());
  }
  ...
  public boolean equals(ExchangeItem exchangeItem) {
    return exchangeItem instanceof ResourceExchangeItem
