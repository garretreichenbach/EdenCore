            ...
            for (int y = 1; y < VoidSystem.SYSTEM_SIZE; y += 2) {
              for (int x = 1; x < VoidSystem.SYSTEM_SIZE; x += 2) {
                ...
                if (sector == null) {
                  ...
                  // SectorUtil.importSectorFullDir("./data/prefabSectors", "tutorial-v2.0.smsec",
                  // sec, (GameServerState) state);

                  SectorSwitch sw =
                      new SectorSwitch(getAssingedPlayerCharacter(), sec, SectorSwitch.TRANS_JUMP);
