...
public class BlueprintEntry implements BlueprintInterface {
    ...
    private void writeModMappings() throws FileNotFoundException {
        ...
        for (Entry<String, Short> stringShortEntry : BlueprintModMappings.getCurrent().getReverseNamespacedBlocks().entrySet()) {
    ...
    public void readHeader(File header) throws IOException {
        try{
            ...
            System.err.println("ERROR: "+headerVersion+"; "+getName()+"; "+blueprintSavedInGameVersion);
            throw e;
        }
    }
