...
public class BuildSectorBoundary extends Observable implements Drawable, Shaderable {
	...
	private final static FloatBuffer fbPerc = BufferUtils.createFloatBuffer(MAX_NUM);
	private final static FloatBuffer fb = BufferUtils.createFloatBuffer(MAX_NUM * 3);
	private final static Vector3f[] tmpP = new Vector3f[16];
	private final static Transform[] contacts = new Transform[MAX_NUM];
